...
#
# 96x32 sheet, three 32x32 markers side by side:
#   0 = Tinted Rock (cyan)   1 = Super Tinted Rock (gold)   2 = Crawlspace (violet)
#
...
$bmp = New-Object System.Drawing.Bitmap 96, 32, ([System.Drawing.Imaging.PixelFormat]::Format32bppArgb)
